    ...
    grunt.initConfig({
        ...
        copy: {
            dist: {
                ...
                , {
                    expand: true,
                    cwd: '<% if (!compassBootstrap) { %>bower_components/bootstrap/dist<% } else { %>.<% } %>',
                    src: '<% if (compassBootstrap) { %>bower_components/bootstrap-sass-official/assets/fonts/bootstrap<% } else { %>fonts<% } %>/*',
                    dest: '<%%= yeoman.dist %>'
                } // <% } %>
                ]
            },
        ...
        ngconstant: {
            ...
            test: {
                ...
                constants: {
                    ENV: {
                        name: 'test',
                        apiEndpoint: 'http://11.11.11.11:8080/project-name-api'
                    }
                }
            },
            prod: {
                ...
                constants: {
                    ENV: {
                        name: 'prod',
                        apiEndpoint: 'http://22.22.22.22:8080/project-name-api'
                    }
                }
            }
        },
